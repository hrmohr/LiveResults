...
package dk.cubing.liveresults.dao.wca;

import dk.cubing.liveresults.dao.GenericDAO;
...
public class CompetitionDAO extends GenericDAO<Competition, String> {
    ...
    public List<Competition> list(int page, int size) {
        Query query = getEntityManager().createQuery("FROM dk.cubing.liveresults.model.wca.Competition");
