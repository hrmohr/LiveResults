...
<html>
    ...
    <body>
        ...
        <s:form action="editCompetition" method="get">
            <table cellpadding="0" cellspacing="0" id="choices"><tr><td>
               <div class="space"><div class="buttborder"><s:submit value="%{getText('admin.competition.new')}" cssClass="butt"/></div></div>
            </td></tr></table><br />
        </s:form>        
	        ...
	        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="results">
	            ...
	            <tbody>
			        <s:iterator value="competitions" status="rowstatus">
			          <s:url id="editCompetitionUrl" action="editCompetition">
			          ...
			          <tr class="<s:if test="#rowstatus.even == true">e</s:if>">
	                      ...
	                      <td><s:a href="%{editCompetitionUrl}" cssClass="c"><s:property value="name" /></s:a></td>
