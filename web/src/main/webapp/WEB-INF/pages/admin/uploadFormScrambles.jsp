...
<html>
    <head>
        <title><s:text name="admin.scrambles.title" /></title>
    </head>
    <body>
        ...
        <h1><s:text name="admin.scrambles.title" /></h1>
        
        <s:form method="POST" enctype="multipart/form-data" action="uploadCsvScrambles">
            <s:token />
