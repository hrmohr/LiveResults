					...
					<xsl:for-each select="diplomas/diploma">
						<fo:block break-before="page" border-style="solid"
							...
							<fo:block border-style="solid" border-width="2pt"
								...
								<fo:block margin-top="1cm">er</fo:block>
								<fo:block font-size="36pt">
									<xsl:apply-templates select="competitorName" />
								</fo:block>
								<fo:block margin-top="1cm">med et finale resultat på
								</fo:block>
								<fo:block font-size="36pt">
								...
								<fo:block margin-top="3.5cm">
									...
									<fo:table>
										...
										<fo:table-header>
											<fo:table-row>
												<fo:table-cell>
													<fo:block font-weight="bold">Arrangør</fo:block>
												</fo:table-cell>
												<fo:table-cell>
													<fo:block font-weight="bold">WCA Delegeret</fo:block>
												</fo:table-cell>
											</fo:table-row>
										</fo:table-header>
										<fo:table-body>
